...
class Address(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    producerid = models.ForeignKey('Producer', models.DO_NOTHING, db_column='ProducerID')  # Field name made lowercase.
    userid = models.ForeignKey('User', models.DO_NOTHING, db_column='UserID')  # Field name made lowercase.
...
class BookGenre(models.Model):
    bookproductid = models.OneToOneField(Book, models.DO_NOTHING, db_column='BookProductID', primary_key=True)  # Field name made lowercase.
...
class Card(models.Model):
    ...
    paymentid = models.OneToOneField('Payment', models.DO_NOTHING, db_column='PaymentID', primary_key=True)  # Field name made lowercase.
...
class Cartline(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    shoppingcartid = models.ForeignKey('Shoppingcart', models.DO_NOTHING, db_column='ShoppingCartID')  # Field name made lowercase.
...
class Fullname(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    bookproductid = models.ForeignKey(Book, models.DO_NOTHING, db_column='BookProductID')  # Field name made lowercase.
    userid = models.ForeignKey('User', models.DO_NOTHING, db_column='UserID')  # Field name made lowercase.
...
class Historyline(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    orderhistoryid = models.ForeignKey('Orderhistory', models.DO_NOTHING, db_column='OrderHistoryID')  # Field name made lowercase.
...
class Importingrecord(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    warehousestaffuserid = models.ForeignKey('Warehousestaff', models.DO_NOTHING, db_column='WarehouseStaffUserID')  # Field name made lowercase.
...
class Item(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    cartlineid = models.ForeignKey(Cartline, models.DO_NOTHING, db_column='CartLineID')  # Field name made lowercase.
...
class Order(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    orderprocessstaffuserid = models.ForeignKey('Orderprocessstaff', models.DO_NOTHING, db_column='OrderProcessStaffUserID')  # Field name made lowercase.
    customerid = models.ForeignKey(Customer, models.DO_NOTHING, db_column='CustomerID')  # Field name made lowercase.
    customeruserid = models.ForeignKey(Customer, models.DO_NOTHING, db_column='CustomerUserID')  # Field name made lowercase.
    ...
    historylineid = models.ForeignKey(Historyline, models.DO_NOTHING, db_column='HistoryLineID')  # Field name made lowercase.
    customer = models.IntegerField(db_column='Customer', blank=True, null=True)  # Field name made lowercase.
    ...
    shippinginfo = models.IntegerField(db_column='ShippingInfo', blank=True, null=True)  # Field name made lowercase.
...
class Product(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    importingrecordid = models.ForeignKey(Importingrecord, models.DO_NOTHING, db_column='ImportingRecordID')  # Field name made lowercase.
...
class PromotionItem(models.Model):
    promotionid = models.OneToOneField(Promotion, models.DO_NOTHING, db_column='PromotionID', primary_key=True)  # Field name made lowercase.
    itemid = models.ForeignKey(Item, models.DO_NOTHING, db_column='ItemID')  # Field name made lowercase.
