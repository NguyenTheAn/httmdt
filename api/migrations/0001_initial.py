# Generated by Django 3.0.5 on 2021-06-02 14:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('orderinfo', models.CharField(blank=True, db_column='OrderInfo', max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historylineid', models.ForeignKey(db_column='HistoryLineID', on_delete=django.db.models.deletion.CASCADE, to='api.Historyline')),
            ],
            options={
                'db_table': 'order',
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='OrderProcessStaffUserID', on_delete=django.db.models.deletion.CASCADE, to='api.Orderprocessstaff'),
        ),
        migrations.AddField(
            model_name='order',
            name='shippingaddress',
        ...
        migrations.AddField(
            ...
            name='orderhistoryid',
            field=models.ForeignKey(db_column='OrderHistoryID', on_delete=django.db.models.deletion.CASCADE, to='api.Orderhistory'),
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
        ...
        migrations.CreateModel(
            name='Book',
            fields=[
                ('name', models.CharField(blank=True, db_column='Bank', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='PromotionItem',
            fields=[
                ('promotionid', models.OneToOneField(db_column='PromotionID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.Promotion')),
                ('itemid', models.ForeignKey(db_column='ItemID', on_delete=django.db.models.deletion.CASCADE, to='api.Item')),
            ],
            options={
